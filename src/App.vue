...
import { commentLink, inputChangeHandler } from "./helpers/handlerHelpers"
  ...
  <div class="container">
    <section>
      <div class="editorContainer">
        <EditorToolbar @setDefaultContent="setDefaultContent(editor)" @updateDefaultContent="updateDefaultContent" @compareContent="compareContent" @newComment="mNewComment" @addInput="addInput" />
